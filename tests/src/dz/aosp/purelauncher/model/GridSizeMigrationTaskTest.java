...
import dz.aosp.purelauncher.model.GridSizeMigrationTask.MultiStepMigrationTask;
import dz.aosp.purelauncher.util.TestLauncherProvider;
...
public class GridSizeMigrationTaskTest {
    ...
    private static final String TEST_PACKAGE = "dz.aosp.purelauncher.validpackage";
