...
import static dz.aosp.purelauncher.BaseActivity.INVISIBLE_ALL;
import static dz.aosp.purelauncher.BaseActivity.INVISIBLE_BY_APP_TRANSITIONS;
import static dz.aosp.purelauncher.BaseActivity.INVISIBLE_BY_PENDING_FLAGS;
import static dz.aosp.purelauncher.BaseActivity.PENDING_INVISIBLE_BY_WALLPAPER_ANIMATION;
...
import static dz.aosp.purelauncher.Utilities.postAsyncCallback;
import static dz.aosp.purelauncher.allapps.AllAppsTransitionController.ALL_APPS_PROGRESS;
import static dz.aosp.purelauncher.anim.Interpolators.AGGRESSIVE_EASE;
import static dz.aosp.purelauncher.anim.Interpolators.DEACCEL_1_7;
import static dz.aosp.purelauncher.anim.Interpolators.LINEAR;
import static dz.aosp.purelauncher.dragndrop.DragLayer.ALPHA_INDEX_TRANSITIONS;
import static dz.aosp.quickstep.TaskUtils.findTaskViewToLaunch;
import static dz.aosp.quickstep.TaskUtils.getRecentsWindowAnimator;
import static dz.aosp.quickstep.TaskUtils.taskIsATargetWithMode;
...
import dz.aosp.purelauncher.DeviceProfile.OnDeviceProfileChangeListener;
import dz.aosp.purelauncher.InsettableFrameLayout.LayoutParams;
...
import dz.aosp.purelauncher.graphics.DrawableFactory;
...
import dz.aosp.quickstep.util.ClipAnimationHelper;
import dz.aosp.quickstep.util.MultiValueUpdateListener;
import dz.aosp.quickstep.util.RemoteAnimationProvider;
import dz.aosp.quickstep.util.RemoteAnimationTargetSet;
import dz.aosp.quickstep.views.RecentsView;
import dz.aosp.quickstep.views.TaskView;
