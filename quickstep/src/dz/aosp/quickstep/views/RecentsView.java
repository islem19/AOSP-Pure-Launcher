...
package dz.aosp.quickstep.views;

import static dz.aosp.purelauncher.BaseActivity.STATE_HANDLER_INVISIBILITY_FLAGS;
import static dz.aosp.purelauncher.anim.Interpolators.ACCEL;
import static dz.aosp.purelauncher.anim.Interpolators.ACCEL_2;
import static dz.aosp.purelauncher.anim.Interpolators.FAST_OUT_SLOW_IN;
import static dz.aosp.purelauncher.anim.Interpolators.LINEAR;
import static dz.aosp.purelauncher.util.SystemUiController.UI_STATE_OVERVIEW;
import static dz.aosp.quickstep.TaskUtils.checkCurrentOrManagedUserId;
import static dz.aosp.quickstep.WindowTransformSwipeHandler.MIN_PROGRESS_FOR_OVERVIEW;
...
import dz.aosp.purelauncher.BaseActivity;
import dz.aosp.purelauncher.DeviceProfile;
import dz.aosp.purelauncher.Insettable;
import dz.aosp.purelauncher.PagedView;
...
import dz.aosp.purelauncher.anim.PropertyListBuilder;
...
import dz.aosp.purelauncher.util.PendingAnimation;
import dz.aosp.purelauncher.util.Themes;
import dz.aosp.quickstep.OverviewCallbacks;
import dz.aosp.quickstep.QuickScrubController;
import dz.aosp.quickstep.RecentsModel;
import dz.aosp.quickstep.TaskUtils;
import dz.aosp.quickstep.util.ClipAnimationHelper;
import dz.aosp.quickstep.util.TaskViewDrawable;
