...
import static dz.aosp.purelauncher.BaseActivity.INVISIBLE_BY_STATE_HANDLER;
import static dz.aosp.purelauncher.BaseActivity.STATE_HANDLER_INVISIBILITY_FLAGS;
import static dz.aosp.purelauncher.Utilities.SINGLE_FRAME_MS;
...
import static dz.aosp.purelauncher.anim.Interpolators.OVERSHOOT_1_2;
import static dz.aosp.quickstep.QuickScrubController.QUICK_SCRUB_FROM_APP_START_DURATION;
import static dz.aosp.quickstep.TouchConsumer.INTERACTION_NORMAL;
import static dz.aosp.quickstep.TouchConsumer.INTERACTION_QUICK_SCRUB;
import static dz.aosp.quickstep.views.RecentsView.UPDATE_SYSUI_FLAGS_THRESHOLD;
...
import dz.aosp.quickstep.ActivityControlHelper.ActivityInitListener;
import dz.aosp.quickstep.ActivityControlHelper.AnimationFactory;
import dz.aosp.quickstep.ActivityControlHelper.LayoutListener;
import dz.aosp.quickstep.TouchConsumer.InteractionType;
import dz.aosp.quickstep.util.ClipAnimationHelper;
import dz.aosp.quickstep.util.RemoteAnimationTargetSet;
import dz.aosp.quickstep.util.TransformedRect;
