...
import dz.aosp.purelauncher.LauncherInitListener;
...
import dz.aosp.purelauncher.uioverrides.FastOverviewState;
...
import dz.aosp.quickstep.util.LayoutUtils;
...
import dz.aosp.quickstep.views.LauncherLayoutListener;
...
public interface ActivityControlHelper<T extends BaseDraggingActivity> {
    ...
    /**
     * Used for containerType in {@link dz.aosp.purelauncher.logging.UserEventDispatcher}
     */
