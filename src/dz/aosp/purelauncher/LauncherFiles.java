...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "dz.aosp.purelauncher.prefs";
    public static final String MANAGED_USER_PREFERENCES_KEY = "dz.aosp.purelauncher.managedusers.prefs";
    // This preference file is not backed up to cloud.
    public static final String DEVICE_PREFERENCES_KEY = "dz.aosp.purelauncher.device.prefs";
